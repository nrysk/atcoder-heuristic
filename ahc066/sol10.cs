...
public class AnnealSimulator : Simulator
{
    ...
    private const double StartTemperature = 2;
...
public class Solver
{
    ...
    public List<char> Solve()
    {
        ...
        int numMacros = 2000;
        var uniqueMacros = new HashSet<string>(numMacros);

        while (uniqueMacros.Count < numMacros)
        {
        ...
        int itr = 0;
        foreach (string macro in uniqueMacros)
        {
