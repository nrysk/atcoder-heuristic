        ...
        for _ in range(min_number_position[0]):
            ...
            if accompanied_number + 1 < n * n:
                accompanied_number_position = get_number_position(
                    n, a, accompanied_number
                )
                next_accompanied_number_position = get_number_position(
                    n, a, accompanied_number + 1
                )
                if (
                    next_accompanied_number_position[0] // 2
                    > accompanied_number_position[0] // 2
                ):
                    for _ in range(abs(next_accompanied_number_position[1] - n // 2)):
                        operations.append(
                            rotate_conveyors(
                                conveyors,
